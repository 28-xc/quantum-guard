...
**QuantumGuard** 是一款基于零信任架构与后量子密码学的端到端加密（E2EE）文件传输系统。本文档从整体视角描述系统架构、安全模型与前后端分工，供架构评审、安全审计与竞赛答辩使用。
...
- **未绑定邮箱**：新设备登录时直接下发 JWT，允许仅凭密码恢复（适用于竞赛/演示场景）。
...
本项目适用于安全课程设计、竞赛答辩与零信任/后量子 E2EE 技术验证。生产部署前需根据实际威胁模型完成额外审计与加固。
